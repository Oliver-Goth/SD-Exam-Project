...
class OrderServiceTest {
        ...
        void createOrder_validData_savesAndReturnsDto() {
                // Arrange
                CustomerDTO customerDTO = new CustomerDTO(1L, "John", "strongpassword", "john@test.com", "12345",
                ...
                Customer customer = new Customer("John", "strongpassword", "john@test.com", "12345",
                                LocalDate.of(1990, 1, 1));
                customer.setId(1L);
        ...
        void createOrder_customerNotFound_throwsException() {
                CustomerDTO customerDTO = new CustomerDTO(99L, "Missing", "strongpassword", "x@test.com", "000",
                                LocalDate.of(1990, 1, 1));
                RestaurantDTO restaurantDTO = new RestaurantDTO(2L, "Rest", "rest@test.com", "56789", "City", true);
        ...
        void createGuestOrder_createsCustomerAndOrder() {
                ...
                CustomerDTO guest = new CustomerDTO(null, "Guest", "strongpassword", "guest@test.com", "9999",
                                LocalDate.of(1990, 1, 1));
                ...
                CustomerDTO savedGuest = new CustomerDTO(5L, "Guest", "temppassword", "guest@test.com", "9999",
                                LocalDate.of(1990, 1, 1));
                when(customerService.createGuestCustomer(
                                guest.getName(), guest.getPassword(), guest.getEmail(), guest.getPhoneNumber(),
                                guest.getDateOfBirth()))
                                .thenReturn(savedGuest);

                Customer customerEntity = new Customer("Guest", "strongpassword", "guest@test.com", "9999",
                                LocalDate.of(1990, 1, 1));
                ...
                verify(customerService, times(1))
                                .createGuestCustomer(guest.getName(), guest.getPassword(), guest.getEmail(),
